...
<body>
  ...
  <div id="hero" class="valign-wrapper">
      <section id="slider">
        <div class="slider white fullscreen">

          <ul class="slides">
            <!--<li class="purple darken-1">-->
            <li class="purple darken-1">
              <img src="assets/custom/images/manage-contacts-export.png"> <!-- random image -->
              <div class="caption right-align">
                <div class="row">
                  <h2 class="light white-text text-darken-1">Introducing</h2>
                  <div class="dark-giant-title">
                    <h1 class="white-text text-darken-1"><span class="text-highlight">ingenious</span></h1>
                  </div>
                  <h5 class="light white-text text-darken-1"><span>Data Management Platform</span></h5>
                </div>
                <div class="divider2"></div>
                <div class="row">
                  <a href="#about" id="download-button" class="btn-large waves-effect waves-light orange accent-2" target="_blank">Get Started</a>
                </div>
              </div>
            </li>
            <li class="deep-purple darken-1">
              <img src="assets/custom/images/manage-contacts-export.png"> <!-- random image -->
              <div class="caption right-align">
                <div class="row">
                  <h2 class="light white-text text-darken-1">Based on the</h2>
                  <div class="dark-giant-title">
                    <h1 class="white-text text-darken-1"><span class="text-highlight">Ideology</span></h1>
                  </div>
                  <h5 class="light white-text text-darken-1"><span>of Google Material Design</span></h5>
                </div>
                <div class="divider2"></div>
                <div class="row">
                  <a href="#about" id="download-button" class="btn-large waves-effect waves-light orange accent-2" target="_blank">Get Started</a>
            ...
            <li class="pink darken-1">
              ...
              <div class="caption right-align">
                <div class="row">
                  <h2 class="light white-text text-darken-1">Made by</h2>
                  <div class="dark-giant-title">
                    <h1 class="white-text text-darken-1"><span class="text-highlight">Neuethemes</span></h1>
                  </div>
                  <h5 class="light white-text text-darken-1"><span>especially for you</span></h5>
                </div>
                <div class="divider2"></div>
                <div class="row">
                  <a href="#about" id="download-button" class="btn-large waves-effect waves-light orange accent-2" target="_blank">Get Started</a>
            ...
            <li class="indigo darken-1">
              <img src="assets/custom/images/manage-contacts-export.png"> <!-- random image -->
              <div class="caption right-align">
                <div class="row">
                  <h2 class="light white-text text-darken-1">Download the</h2>
                  <div class="dark-giant-title">
                    <h1 class="white-text text-darken-1"><span class="text-highlight">Materializer</span></h1>
                  </div>
                  <h5 class="light white-text text-darken-1"><span>and get the lifetime updates</span></h5>
                </div>
                <div class="divider2"></div>
                <div class="row">
                  <a href="#about" id="download-button" class="btn-large waves-effect waves-light orange accent-2" target="_blank">Get Started</a>
				...
				<div class="row">
					...
					<div class="col s12 m6 l3">
						<div class="pricing plain z-depth-1 hoverable">
							...
							<button type="button" class="waves-effect waves-light btn blue-grey darken-3 center">Sign Up</button>
